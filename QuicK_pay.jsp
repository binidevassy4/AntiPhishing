...
<html>
    <head>
        ...
        <title>AntiPhishing::Quick Pay</title>
    ...
    <body>
        ...
        <%
                 ...
                 %>
        <script>alert("Can't transfer!. Check the IFSC code and branch");</script>
        <%
                }
            }else{
             %>
        <script>alert("Can't transfer!.Check the Account Number");</script>
        <%
            }
        %>
                        ...
                        <form>
                            <table  align="center" cellpadding="12" >
                                ...
                                <tr align="center">
                                    ...
                                    <td>
                                        <input type="text" name="txt_branch" value="" placeholder="             Enter the Branch" size="40" style="background-color:#fff;height:40px; width:300px;border-radius: 12px;box-shadow: 0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19);">
                                    </td>
                                </tr>
                                <tr align="center">

                                    <td>
                                        <input type="text" name="txt_ifsc" value="" placeholder="             Enter IFSC Code" size="40" style="background-color:#fff;height:40px; width:300px;border-radius: 12px;box-shadow: 0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19);">
                                    </td>
                                </tr>
                                <tr align="center">

                                    <td>
                                        <input type="text" name="txt_acc" value="" placeholder="             Enter Account Number" size="40" style="background-color:#fff;height:40px; width:300px;border-radius: 12px;box-shadow: 0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19);">
                                    </td>
                                </tr>
                                <tr align="center">
                                ...
                                <tr align="center">
                                    ...
                                    <td>
                                        <input type="number" name="txtamt" value="" placeholder="             Transfer Amount " size="40" style="background-color:#fff;height:40px; width:300px;border-radius: 12px;box-shadow: 0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19);">
                                    </td>
                                </tr>
                                <tr align="center">
                                ...
                                <tr align="center">
                                    <td colspan="2" align="center">
                                        <input type="submit" name="btnsubmit" size="40" style="background-color:#fff;height:40px; width:150px;border-radius: 12px;box-shadow: 0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19);" value="Fund Transfer">
                                    </td>
                                </tr>
                            </table>
                        </form>
